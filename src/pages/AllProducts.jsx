            ...
            <div>
                        ...
                        <div class="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                            ...
                            <form class="mt-4 border-t border-gray-200">
                                ...
                                <ul role="list" class="px-2 py-3 font-medium text-gray-900">
                                    <li>
                                        <a href="#" class="block px-2 py-3">Інструменти</a>
                                    </li>
                                    <li>
                                        <a href="#" class="block px-2 py-3">Автозапчатини</a>
                                    </li>
                                    <li>
                                        <a href="#" class="block px-2 py-3">Автоаксесуари</a>
                                    </li>
                                    <li>
                                        <a href="#" class="block px-2 py-3">Кріплення</a>
                                    </li>
                                    <li>
                                        <a href="#" class="block px-2 py-3">Хімія</a>
                                    </li>
                                    <li>
                                        <a href="#" class="block px-2 py-3">Кемпінг</a>
                                    </li>
                                </ul>
                ...
                <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-6">
                        <h1 class="text-3xl font-bold tracking-tight text-gray-900">Каталог товарів</h1>

                        <div class="flex items-center">
                            <div class="relative inline-block text-left">
                                <div>
                                    <button type="button" class="group inline-flex justify-center text-sm font-medium text-gray-700 hover:text-gray-900" id="menu-button" aria-expanded="false" aria-haspopup="true" onClick={toggleDropdown}>
                                        Сортувати
                                ...
                                {isOpen && (
                                    <div class="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                                        <div class="py-1" role="none">
                                            <a href="#" class="font-medium text-gray-900 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">Популярні</a>
                                            <a href="#" class="text-gray-500 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-2">Найновіші</a>
                                            <a href="#" class="text-gray-500 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-3">Від: Дешевших до найдорожчіх</a>
                                            <a href="#" class="text-gray-500 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-4">Від: Найдорожчіх до дешевих</a>
                                        </div>
                                    </div>
                                )}
                            </div>
                    ...
                    <section aria-labelledby="products-heading" class="pb-24 pt-6">
                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                            <form class="hidden lg:block">
                                <h3 class="sr-only">Categories</h3>
                                <ul role="list" class="space-y-4 border-b items-start text-left border-gray-200 pb-6 text-sm font-medium text-gray-900">
                                    <li>
                                        <a href="#" class="block px-1 py-2">Всі товари</a>
                                    </li>
                                    <li>
                                        <a href="#" class="block px-1 py-2">Інструменти</a>
                                    </li>
                                    <li>
                                        <a href="#" class="block px-1 py-2">Автозапчатини</a>
                                    </li>
                                    <li>
                                        <a href="#" class="block px-1 py-2">Автоаксесуари</a>
                                    </li>
                                    <li>
                                        <a href="#" class="block px-1 py-2">Кріплення</a>
                                    </li>
                                    <li>
                                        <a href="#" class="block px-1 py-2">Хімія</a>
                                    </li>
                                    <li>
                                        <a href="#" class="block px-1 py-2">Кемпінг</a>
                                    </li>
                                </ul>
                                ...
                                <div class="border-b border-gray-200 py-6">
                                    ...
                                    <div class="pt-1" id="filter-section-1">
                                        <div class="space-y-4">
                                            <div class="flex items-center">
